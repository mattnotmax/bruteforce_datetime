...
def bruteforce_datetime():
    ...
    while True:
        try:
            ...
            print('Error: check your command-line parameters. Should be ./brutus.py <filename> YYYY')
            sys.exit()
        else:
    ...
    with open(sys.argv[1], 'rb') as file_open:
        ...
        if bool(date_dic) == False:
            ...
            print('Possible Windows little-endian FILETIME records matching the year {} as follows:'.format(date_setting))
